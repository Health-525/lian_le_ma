...
const styles = StyleSheet.create({
  ...
  title: { fontSize: font.display, fontWeight: "900", color: colors.text, letterSpacing: -1, marginTop: spacing(2), marginBottom: spacing(5) },
  ...
  sectionTitle: { fontSize: font.small, fontWeight: "700", color: colors.textFaint, letterSpacing: 0.5, marginTop: spacing(7), marginBottom: spacing(3) },

  stats: { flexDirection: "row", alignItems: "center", paddingVertical: spacing(4), backgroundColor: colors.bgElevated, borderRadius: radius.lg },
